function fileoutpos = importProbePoses(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   FILEOUTPOS = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   FILEOUTPOS = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   fileoutpos = importfile('fileoutpos.txt', 1, 25);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2015/07/02 18:46:35
